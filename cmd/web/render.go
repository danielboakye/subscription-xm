...
func (app *Config) AddDefaultData(td *TemplateData, r *http.Request) *TemplateData {
	td.Flash = app.Session.PopString(r.Context(), notifyFlash)
	td.Warning = app.Session.PopString(r.Context(), notifyWarning)
	td.Error = app.Session.PopString(r.Context(), notifyError)
